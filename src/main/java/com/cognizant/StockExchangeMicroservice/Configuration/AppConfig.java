...
@ComponentScans(value={@ComponentScan("com.cognizant.StockExchangeMicroservice.Dao"),
		@ComponentScan("com.cognizant.StockExchangeMicroservice.Service")
})
public class AppConfig {
	 @Autowired
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
	      ...
	      factoryBean.setPackagesToScan("com.cognizant.StockExchangeMicroservice.Entity");
	      return factoryBean;
	   }
